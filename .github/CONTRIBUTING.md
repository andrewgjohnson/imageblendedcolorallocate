...
The project uses the [PHP_CodeSniffer](https://github.com/squizlabs/php_codesniffer) linter tool to enforce coding standards in the [PHP source](https://imageblendedcolorallocate.agjgd.org/source/), [unit tests](https://github.com/andrewgjohnson/imageblendedcolorallocate/tree/master/tests) and [examples](https://imageblendedcolorallocate.agjgd.org/examples/). The project uses the PHP_CodeSniffer [PSR-12](https://www.php-fig.org/psr/psr-12/) ruleset defined in the [PHP_CodeSniffer configuration file](https://github.com/andrewgjohnson/imageblendedcolorallocate/blob/master/phpcs.xml.dist). Run this command to test all code changes:
...
The project uses [PHPUnit](https://phpunit.de/) framework to run unit tests. The tests are all located in the [`tests` folder](https://github.com/andrewgjohnson/imageblendedcolorallocate/tree/master/tests). All tests should continue to pass and all new features should ideally include unit tests. Run this command to execute all unit tests:

    composer phpunit

### Online Documentation

The project’s online documentation is available at [imageblendedcolorallocate.agjgd.org](https://imageblendedcolorallocate.agjgd.org/). Please ensure the documentation is updated along with any code changes. All of the files used to generate the documentation are in the [`documentation` folder](https://github.com/andrewgjohnson/imageblendedcolorallocate/blob/master/documentation/). [The website](https://imageblendedcolorallocate.agjgd.org/) is powered by [GitHub Pages](https://pages.github.com/) which uses [Jekyll](https://jekyllrb.com/). Run this command to test the online documentation website locally if you have Jekyll installed:
...
In order to participate your behaviour must conform to our [code of conduct](https://github.com/andrewgjohnson/imageblendedcolorallocate/blob/master/.github/CODE_OF_CONDUCT.md).
